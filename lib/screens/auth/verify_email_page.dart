...
class _VerifyEmailPageState extends State<VerifyEmailPage> {
  ...
  Future<void> checkEmailVerified() async {
    ...
    try {
      ...
      if (user != null && user.emailVerified) {
        ...
        showMessage('Email not verified yet. Please check your inbox or spam folder.');
      }
    } catch (e) {
  ...
  Future<void> resendVerificationEmail() async {
    ...
    try {
      ...
      showMessage('Verification email sent again. Please check your inbox or spam folder.');
    } catch (e) {

...
class _AdminPostManagementPageState extends State<AdminPostManagementPage> {
  ...
  Future<void> banPost(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Post banned successfully'),
        ),
      );
    } catch (e) {
      if (!context.mounted) return;
